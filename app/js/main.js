...
function startAnimation1 () {
    if (animation1initiated) {
        ...
        animation1.to("#box-1-minutehand", 15, {ease: Power0.easeNone,rotation:720 - 90});
        animation1.to("#box-1-hourhand", 15, {ease: Power0.easeNone,rotation:360 - 90},"-=15");
...
function startAnimation4 () {
    if (animation4initiated) {
        ...
        animation4 = new TimelineMax({repeatDelay:2});
...
//     .addTo(controller); // assign the scene to the controller
    ...
    var scene = new ScrollMagic.Scene({triggerElement: "#box-1", duration: 250})
        .addTo(controller)
    ...
    var scene2 = new ScrollMagic.Scene({triggerElement: "#box-2", duration: 250})
        .addTo(controller)
        .addIndicators() // add indicators (requires plugin)
        .on("update", function (e) {
            $("#scrollDirection").text(e.target.controller().info("scrollDirection"));
    ...
    var scene3 = new ScrollMagic.Scene({triggerElement: "#box-3", duration: 250})
        .addTo(controller)
        .addIndicators() // add indicators (requires plugin)
        .on("update", function (e) {
            $("#scrollDirection").text(e.target.controller().info("scrollDirection"));
    ...
    var scene4 = new ScrollMagic.Scene({triggerElement: "#box-4", duration: 250})
        .addTo(controller)
        .addIndicators() // add indicators (requires plugin)
        .on("update", function (e) {
            $("#scrollDirection").text(e.target.controller().info("scrollDirection"));
